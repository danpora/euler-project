...
// *EULER_STRING* (defined below)
//Find the thirteen adjacent digits in the 1000-digit number that have the greatest product. What is the value of this product?
public class Euler8 {
    final static String EULER_STRING = "73167176531330624919225119674426574742355349194934" +
    ...
    public static void main(String[] args) {
        ...
        System.out.println(greatProdSeries(EULER_STRING, 13));
